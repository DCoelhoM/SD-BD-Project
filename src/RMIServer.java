...
public interface RMIServer extends java.rmi.Remote {
    ...
    //AUCTIONS
    public boolean create_auction(int code, String title, String description, Date deadline, int amount) throws java.rmi.RemoteException;
    public ArrayList<Auction> search_auction() throws java.rmi.RemoteException;
    public Auction detail_auction() throws java.rmi.RemoteException;
    public ArrayList<Auction> my_auctions() throws java.rmi.RemoteException;
